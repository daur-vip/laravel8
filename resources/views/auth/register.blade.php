...
<body class="bg-light-gray" id="body">
    <div class="container d-flex flex-column justify-content-between vh-100">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 mb-4">
                                    <input class="form-control input-lg" id="name" type="text" name="name" :value="old('name')" 
                                    required autofocus autocomplete="name" placeholder="Name">
                                </div>
                                <div class="form-group col-md-12 mb-4">
                                    <input type="email" name="email" class="form-control input-lg" aria-describedby="emailHelp"
                                        placeholder="Email">
                                </div>
        ...
        <div class="copyright pl-0">
            <p class="text-center">&copy; Easy Dashboard by
                <a class="text-primary" href="http://daur.vip/" target="_blank">Daur</a>.
            </p>
        </div>
    </div>
</body>
